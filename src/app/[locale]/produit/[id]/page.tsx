    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm mb-4">{t("product.notFound")}</p>
          <button
            onClick={() => router.push("/")}
              ...
              <div className="flex-1">
                ...
                {product.description && (
                  <div className="mt-6 pt-6 border-t border-gray-100">
                    <h2 className="text-xs font-bold text-gray-400 uppercase tracking-[0.08em] mb-3">{t("product.description")}</h2>
