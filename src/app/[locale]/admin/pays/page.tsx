...
export default function PaysPage() {
  ...
  const tCarrier = useTranslations("carriers");
  ...
  const filteredCountryList = useMemo(() => {
    ...
    return ALL_COUNTRIES.filter(c => {
      const translatedName = tc(c.code as "FR" | "BE" | "CH" | "LU" | "MC" | "DE" | "IT" | "ES" | "NL" | "AT" | "PT" | "GB" | "IE" | "DK" | "SE" | "FI" | "PL" | "CZ" | "RO" | "HU" | "BG" | "HR" | "SI" | "SK" | "LT" | "LV" | "EE" | "GR" | "CY" | "MT" | "NO" | "IS" | "US" | "CA" | "JP" | "AU" | "NZ" | "BR" | "MX" | "IN" | "CN" | "KR" | "SG" | "IL" | "AE" | "ZA" | "MA" | "TN" | "DZ" | "TR" | "RU" | "UA" | "AD" | "LI" | "SM" | "VA").toLowerCase();
      return translatedName.toLowerCase().includes(q) || c.code.toLowerCase().includes(q);
    });
  }, [countrySearch, tc]);
  ...
  const selectAllCountries = () => {
    const q = countrySearch.toLowerCase().trim();
    const filtered = q ? ALL_COUNTRIES.filter(c => {
      const translatedName = tc(c.code as "FR" | "BE" | "CH" | "LU" | "MC" | "DE" | "IT" | "ES" | "NL" | "AT" | "PT" | "GB" | "IE" | "DK" | "SE" | "FI" | "PL" | "CZ" | "RO" | "HU" | "BG" | "HR" | "SI" | "SK" | "LT" | "LV" | "EE" | "GR" | "CY" | "MT" | "NO" | "IS" | "US" | "CA" | "JP" | "AU" | "NZ" | "BR" | "MX" | "IN" | "CN" | "KR" | "SG" | "IL" | "AE" | "ZA" | "MA" | "TN" | "DZ" | "TR" | "RU" | "UA" | "AD" | "LI" | "SM" | "VA").toLowerCase();
      return translatedName.toLowerCase().includes(q) || c.code.toLowerCase().includes(q);
    }) : ALL_COUNTRIES;
    setSelectedCountries(prev => {
  ...
  const saveCountries = async () => {
    if (selectedCountries.length === 0) { alert(t("selectAtLeastOne")); return; }
    ...
    <section>
      <div className="flex items-center justify-between mb-2.5 px-1">
        <div className="flex items-center gap-2">
          ...
          {countriesLoaded && (
            <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-emerald-100 text-emerald-700">{selectedCountries.length} {t("countries")}</span>
          )}
        </div>
      </div>
      <div className="bg-white rounded-2xl border border-gray-200/60 p-4 sm:p-5">
        ...
        {shippingLoaded && (
          <div className="mb-4">
            <p className="text-[10px] font-semibold text-gray-500 uppercase tracking-wider mb-2">{t("quickSelect")}</p>
              ...
              {CARRIER_PRESETS.map(carrier => {
                ...
                return (
                  ...
                  >
                    ...
                    {tCarrier((carrier.id + ".name") as any)}
              ...
              {filteredCountryList.map(country => {
                ...
                return (
                  <label key={country.code} className={`flex items-center gap-2.5 px-3 py-2 rounded-lg cursor-pointer transition-colors text-sm ${checked ? "bg-violet-50 text-violet-900" : "hover:bg-gray-50 text-gray-700"}`}>
                    ...
                    />
                    <span className="font-medium">{tc(country.code as "FR" | "BE" | "CH" | "LU" | "MC" | "DE" | "IT" | "ES" | "NL" | "AT" | "PT" | "GB" | "IE" | "DK" | "SE" | "FI" | "PL" | "CZ" | "RO" | "HU" | "BG" | "HR" | "SI" | "SK" | "LT" | "LV" | "EE" | "GR" | "CY" | "MT" | "NO" | "IS" | "US" | "CA" | "JP" | "AU" | "NZ" | "BR" | "MX" | "IN" | "CN" | "KR" | "SG" | "IL" | "AE" | "ZA" | "MA" | "TN" | "DZ" | "TR" | "RU" | "UA" | "AD" | "LI" | "SM" | "VA")}</span>
                    <span className="text-[10px] text-gray-400 font-mono ml-auto">{country.code}</span>
                  </label>
                );
              })}
              {filteredCountryList.length === 0 && (
                <div className="col-span-full text-center text-xs text-gray-400 py-4">{t("noCountryFound")}</div>
              )}
            </div>
